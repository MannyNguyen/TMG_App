...
public class JonHenryFragment extends Fragment implements OnScrollListener,
	...
	class BG_getNews extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			// just show dialog when need refresh data.Not in case: tranfer
			// tab Pull list
		...
		protected void onPostExecute(String result) {
			...
			if (MainActivity.timeout == 1) {
				...
				try {
					...
					mAdapter.setOnGridClickListener(JonHenryFragment.this);
	...
	private void initHeaderGridView() {
		...
		headerButton.setOnClickListener(JonHenryFragment.this);
	...
	private void initGridView() {
		...
		gridView.setOnRefreshListener(JonHenryFragment.this);
		gridView.setOnScrollListener(JonHenryFragment.this);
