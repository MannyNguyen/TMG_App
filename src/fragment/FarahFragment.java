...
public class FarahFragment extends Fragment implements OnScrollListener,
		...
		protected void onPostExecute(String result) {
			...
			if (MainActivity.timeout == 1) {
				...
				try {
					...
					mAdapter.setOnGridClickListener(FarahFragment.this);
...
//					gridView.setSelection(currentPage);
	...
	private void initHeaderGridView() {
		...
		headerButton.setOnClickListener(FarahFragment.this);
	...
	private void initGridView() {
		...
		gridView.setOnRefreshListener(FarahFragment.this);
		gridView.setOnScrollListener(FarahFragment.this);
	}
