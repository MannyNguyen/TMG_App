 ...
 * @author Jeff Gilfelt
 */
public class BadgeViewNoNumber extends TextView {
	...
	private static final int DEFAULT_CORNER_RADIUS_DIP = 1000;
	...
	public BadgeViewNoNumber(Context context) {
		this(context, (AttributeSet) null, android.R.attr.textViewStyle);
	}
	
	public BadgeViewNoNumber(Context context, AttributeSet attrs) {
     ...
     */
	public BadgeViewNoNumber(Context context, View target) {
     ...
     */
	public BadgeViewNoNumber(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}
	
	public BadgeViewNoNumber(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}
	
	public BadgeViewNoNumber(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
