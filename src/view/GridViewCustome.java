 ...
 *
 */
public class GridViewCustome extends android.widget.GridView implements OnScrollListener, android.widget.AdapterView.OnItemClickListener
{
	...
	public GridViewCustome(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public GridViewCustome(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public GridViewCustome(Context context) {
		super(context);
		init(context);
	}
    ...
    public class mListAdapter extends BaseAdapter
    {
		...
		public int getCount() 
		{
			return originalAdapter.getCount() > 0 ? originalAdapter.getCount() + GridViewCustome.this.getNumColumnsCompat() : 0;
		}

		@Override
		public Object getItem(int position) 
		{
			return originalAdapter.getItem(position + GridViewCustome.this.getNumColumnsCompat());
		}

		@Override
		public long getItemId(int position) 
		{
			return originalAdapter.getItemId(position + GridViewCustome.this.getNumColumnsCompat());
		}
		...
		{
			if ( position < GridViewCustome.this.getNumColumnsCompat() )
			{
		...
		public View getView(int position, View convert, ViewGroup parent) 
		{
			if ( position < GridViewCustome.this.getNumColumnsCompat() )
			{
				...
				int realPosition = position - GridViewCustome.this.getNumColumnsCompat();
	...
	public void onItemClick(AdapterView<?> adapter, View view, int position, long id) 
	{
		...
		{
			clickListenerFromActivity.onItemClick(adapter, view, position - GridViewCustome.this.getNumColumnsCompat(), id);
		}
	}
}