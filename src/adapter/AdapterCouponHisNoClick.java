...
public class AdapterCouponHisNoClick extends BaseAdapter {

	Context mContext;
	ArrayList<Coupon> array ;
	ImageDownloaderMainBanners loader;
	public AdapterCouponHisNoClick(Context mContext, ArrayList<Coupon> array) {
...
//		if(convertView == null)
//		{
			convertView = View.inflate(mContext, R.layout.item_coupon_list_no_arrow, null);
